...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   ///-ini file path設定##################
    ...
    DWORD	str_num = GetPrivateProfileString(SYSTEM_SECT_OF_INIFILE, ODER_CODE_KEY_OF_INIFILE, L"XXXXXX", pEnvStat->device_code.crane_id, _countof(pEnvStat->device_code.crane_id), PATH_OF_INIFILE);

...
#include ".\Cranes\HHGH2900_PanelObj.h"
#include ".\Cranes\H6R60200_PanelObj.h"
#include ".\Cranes\HHGQ1800_PanelObj .h"
...
CPanelObjBase::CPanelObjBase(HWND _hwnd,int _crane_id)
{
	hPnlWnd = _hwnd;
	crane_id = _crane_id;
	setup_jc_graphics(hPnlWnd);
}
CPanelObjBase::~CPanelObjBase() {
	clear_graphics();
}

//### グラフィックメインオペレーションパネルウィンドウオブジェクト　セットアップ ###
HRESULT CPanelObjBase::setup_jc_graphics(HWND hwnd) {
	clear_graphics();
...
HRESULT CPanelObjBase::setup_gc_graphics(HWND hwnd) {
	clear_graphics();
...
HRESULT CPanelObjBase::setup_ohc_graphics(HWND hwnd) {
	clear_graphics();
...
//### メインオペレーションパネルウィンドウオブジェクト　セットアップ ###
...
static Image* img_estp_of; static Image* img_estp_on; static Image* img_estp_of2; static Image* img_estp_on2;
static Image* img_freset_of; static Image* img_freset_on;

HRESULT CMainPanelObj::setup_jc_obj(int _crane_id) { 
	switch (_crane_id) {
	case CRANE_ID_H6R602: 
		for (int i = 0; i < N_MAIN_PNL_OBJ; i++) main_props[i] = main_props_h6r602[i];
		break;
	case CRANE_ID_HHGQ18: 
		for (int i = 0; i < N_MAIN_PNL_OBJ; i++) main_props[i] = main_props_hhgq18[i];
		break;
	case CRANE_ID_HHGH29:
	default:
		for (int i = 0; i < N_MAIN_PNL_OBJ; i++) main_props[i] = main_props_hhgh29[i];
		break;
	};
	...
	case CRANE_ID_HHGQ18:
	{
		...
		img_b1_of = new Image(L"../Img/HHGQ18/lmp1_b_of.png"); img_b1_on = new Image(L"../Img/HHGQ18/lmp1_b_on.png"); img_y1_on = new Image(L"../Img/HHGQ18/lmp1_y_on.png"); img_g1_on = new Image(L"../Img/HHGQ18/lmp1_g_on.png"); img_r1_on = new Image(L"../Img/HHGQ18/lmp1_r_on.png");
		img_estp_of = new Image(L"../Img/HHGQ18/estop_of.png"); img_estp_on = new Image(L"../Img/HHGQ18/estop_on.png"); img_estp_of2 = new Image(L"../Img/HHGQ18/estop_of2.png"); img_estp_on2 = new Image(L"../Img/HHGQ18/estop_on2.png");
		img_w80_of = new Image(L"../Img/HHGQ18/sw80_of_w.png"); img_b80_on = new Image(L"../Img/HHGQ18/sw80_on_b.png"); img_g80_on = new Image(L"../Img/HHGQ18/sw80_on_g.png"); img_r80_on = new Image(L"../Img/HHGQ18/sw80_on_r.png");
		img_freset_of = new Image(L"../Img/HHGQ18/freset_off.png"); img_freset_on = new Image(L"../Img/HHGQ18/freset_on.png");
	}break;
	case CRANE_ID_HHGH29:
	default:
	{
		img_o80_of = new Image(L"../Img/HHGH29/sw80_of_o.png"); img_o80_on = new Image(L"../Img/HHGH29/sw80_on_o.png");
		img_b1_of = new Image(L"../Img/HHGH29/lmp1_b_of.png"); img_b1_on = new Image(L"../Img/HHGH29/lmp1_b_on.png"); img_y1_on = new Image(L"../Img/HHGH29/lmp1_y_on.png"); img_g1_on = new Image(L"../Img/HHGH29/lmp1_g_on.png"); img_r1_on = new Image(L"../Img/HHGH29/lmp1_r_on.png");
		img_estp_of = new Image(L"../Img/HHGH29/estop_of.png"); img_estp_on = new Image(L"../Img/HHGH29/estop_on.png"); img_estp_of2 = new Image(L"../Img/HHGH29/estop_of2.png"); img_estp_on2 = new Image(L"../Img/HHGH29/estop_on2.png");
		img_w80_of = new Image(L"../Img/HHGH29/sw80_of_w.png"); img_b80_on = new Image(L"../Img/HHGH29/sw80_on_b.png"); img_g80_on = new Image(L"../Img/HHGH29/sw80_on_g.png"); img_r80_on = new Image(L"../Img/HHGH29/sw80_on_r.png");
		img_freset_of = new Image(L"../Img/HHGH29/freset_off.png"); img_freset_on = new Image(L"../Img/HHGH29/freset_on.png");
	}
	}
...
//0 メッセージ,クレーンTXT
	...
	i++;str_crane_txt		= new CStringGdi(ID_MAIN_PNL_OBJ_STR_MESSAGE, &main_props[i].pt, &main_props[i].sz, main_props[i].txt,
											pgraphic, drawing_items.pstrformat[ID_STR_FORMAT_LEFT_CENTER], drawing_items.pbrush[ID_PANEL_COLOR_WHITE], drawing_items.pbrush[ID_PANEL_COLOR_DGRAY], drawing_items.pfont[ID_PANEL_FONT_32]);
...
HRESULT CMainPanelObj::setup_gc_obj(int _crane_id) {
	return S_OK;
}
HRESULT CMainPanelObj::setup_ohc_obj(int _crane_id) {
	return S_OK;
}
void CMainPanelObj::delete_obj() {
	delete str_message;
	delete str_crane_txt;
	delete pb_remote;
	delete lmp_remote;
	...
	delete img_o80_of; delete img_o80_on; delete img_w80_of; delete img_b80_on; delete img_g80_on; delete img_r80_on;
	delete img_b1_of; delete img_b1_on; delete img_y1_on; delete img_g1_on; delete img_r1_on;
	delete img_estp_of; delete img_estp_on; delete img_estp_of2; delete img_estp_on2;
	delete img_freset_of; delete img_freset_on;
...
void CMainPanelObj::refresh_obj_graphics() {
	...
	str_crane_txt->refresh_graphics(pgraphic);
...
HRESULT CSubPanelObj::setup_jc_obj(int _crane_id) {
	...
	case CRANE_ID_HHGQ18:
	{
		...
		for (int i = 0; i < N_SUB_PNL_OBJ; i++) sub_set_props[i] = sub_set_props_hhgq18[i];
	}break;
	case CRANE_ID_HHGH29:
	default:
	{
		...
		for (int i = 0; i < N_SUB_PNL_OBJ; i++) sub_set_props[i] = sub_set_props_hhgh29[i];
	}break;
	};
	...
	i++; cb_mh_spd_mode3		= new CCbCtrl(ID_SUB_PNL_SET_OBJ_RDO_MHSPD_3, &sub_set_props[i].pt, &sub_set_props[i].sz, sub_set_props[i].txt, pgraphic, drawing_items.ppen[ID_PANEL_COLOR_YELLOW], drawing_items.ppen[ID_PANEL_COLOR_DGRAY]);
	CCbCtrl* pcb_opt[8]			= { cb_mh_spd_mode0,cb_mh_spd_mode1,cb_mh_spd_mode2,cb_mh_spd_mode3 };
	i++; rdo_mh_spd_mode		= new CRadioCtrl(4, pcb_opt);
	i++; lmp_mh_spd_mode		= new CSwitchImg(ID_SUB_PNL_SET_OBJ_LMP_MHSPD, &sub_set_props[i].pt, &sub_set_props[i].sz, sub_set_props[i].txt, pimg_cs_mh_spd_mode, 4, 3, pgraphic);
	...
	i++; cb_disp_flt_pc		= new CCbCtrl(ID_SUB_PNL_FLT_OBJ_CB_PCFLT, &sub_set_props[i].pt, &sub_set_props[i].sz, sub_set_props[i].txt, pgraphic, drawing_items.ppen[ID_PANEL_COLOR_BLACK], drawing_items.ppen[ID_PANEL_COLOR_DGRAY]);
...
HRESULT CSubPanelObj::setup_ohc_obj(int _crane_id) {
...
//### メイングラフィックウィンドウオブジェクト　セットアップ ###
Image* img_gwin_bk;
Image* img_boom_xy;
Image* img_crane_gt_base;
Image* img_crane_potal;
HRESULT CGWindowObj::setup_jc_obj(int _crane_id) {
	switch (_crane_id) {
	case  CRANE_ID_H6R602:
	{
		...
		for (int i = 0; i < N_GWIN_OBJ; i++) gwin_set_props[i] = gwin_set_props_h6r602[i];
	}break;
	case CRANE_ID_HHGQ18:
	{
		...
		for (int i = 0; i < N_GWIN_OBJ; i++) gwin_set_props[i] = gwin_set_props_hhgq18[i];
	}break;
	case CRANE_ID_HHGH29:
	default:
	{
		...
		for (int i = 0; i < N_GWIN_OBJ; i++) gwin_set_props[i] = gwin_set_props_hhgh29[i];
	}break;
	}
...
HRESULT CGWindowObj::setup_gc_obj(int _crane_id) {
	return S_OK;
}
HRESULT CGWindowObj::setup_ohc_obj(int _crane_id) {
	return S_OK;
}
...
//### サブグラフィックウィンドウオブジェクト　セットアップ ###
Image* img_gsubwin_bk;
Image* img_boom_yz;
Image* img_hook_mh;
Image* img_hook_load_mh;
HRESULT CGSubWindowObj::setup_jc_obj(int _crane_id) {
	switch (_crane_id) {
	...
	case  CRANE_ID_H6R602:
	{
		...
		for (int i = 0; i < N_GSUBWIN_OBJ; i++) gsubwin_set_props[i] = gsubwin_set_props_h6r602[i];
	...
	case CRANE_ID_HHGQ18:
	{
		...
		for (int i = 0; i < N_GSUBWIN_OBJ; i++) gsubwin_set_props[i] = gsubwin_set_props_hhgq18[i];
	}break;
	case CRANE_ID_HHGH29:
	default:
	{
		...
		for (int i = 0; i < N_GSUBWIN_OBJ; i++) gsubwin_set_props[i] = gsubwin_set_props_hhgh29[i];
	}break;
	}
...
HRESULT CGSubWindowObj::setup_gc_obj(int _crane_id) {

	return S_OK;
}
HRESULT CGSubWindowObj::setup_ohc_obj(int _crane_id) {

...
HWND CSim::open_monitor_wnd(HWND h_parent_wnd, int id) {
	...
	if (id == BC_ID_MON1) {
		...
		st_mon1.hwnd_mon = inf.hwnd_mon1 = CreateWindowW(TEXT("SIM_MON1"), TEXT("SIM_MON1"), WS_OVERLAPPEDWINDOW,
		...
		st_mon2.hwnd_mon = inf.hwnd_mon2 = CreateWindowW(TEXT("SIM_MON2"), TEXT("SIM_MON2"), WS_OVERLAPPEDWINDOW,

...
INT16 CScada::l_rope_mh(double d100) { if (d100 == 0.0)return 0; return INT16(pEnv_Inf->crane_stat.l_mh / d100 * MKLOG_PARAM_DATA_100PER_D); }
INT16 CScada::l_rope_ah(double d100) { if (d100 == 0.0)return 0; return INT16(pEnv_Inf->crane_stat.l_ah / d100 * MKLOG_PARAM_DATA_100PER_D); }
...
INT16 CScada::notch_com_mh(double d100) { return (INT16)d100 * pOTE_Inf->st_msg_ote_u_rcv.body.st.pnl_ctrl[OTE_PNL_CTRLS::notch_mh]; }  //notch(-4～4）*d100　d100=5.0をデフォルト
INT16 CScada::notch_com_gt(double d100) { return (INT16)d100 * pOTE_Inf->st_msg_ote_u_rcv.body.st.pnl_ctrl[OTE_PNL_CTRLS::notch_gt]; }
INT16 CScada::notch_com_bh(double d100) { return (INT16)d100 * pOTE_Inf->st_msg_ote_u_rcv.body.st.pnl_ctrl[OTE_PNL_CTRLS::notch_bh]; }
INT16 CScada::notch_com_sl(double d100) { return (INT16)d100 * pOTE_Inf->st_msg_ote_u_rcv.body.st.pnl_ctrl[OTE_PNL_CTRLS::notch_sl]; }
INT16 CScada::notch_com_ah(double d100) { return (INT16)d100 * pOTE_Inf->st_msg_ote_u_rcv.body.st.pnl_ctrl[OTE_PNL_CTRLS::notch_ah]; }

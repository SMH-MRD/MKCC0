...
#define MKLOG_ITEM_SWY1_T			24
#define MKLOG_ITEM_SWY1_DTHWX		25
#define MKLOG_ITEM_SWY1_DTHWY		26
#define MKLOG_ITEM_SWY1_AMP_X		27
#define MKLOG_ITEM_SWY1_AMP_Y		28
#define MKLOG_ITEM_SWY1_PH_X		29
#define MKLOG_ITEM_SWY1_PH_Y		30
#define MKLOG_ITEM_MHL				31
...
//		  CODE		100%		Title			*func
		...
		{ 0x0004,	3.14 ,		L"SL_POS_FB  ",	NULL },//004 MKLOG_ITEM_SL_POS_FB   
		{ 0x0005,	80.0 ,		L"AH_POS_FB  ",	NULL },//005 MKLOG_ITEM_AH_POS_FB   
		{ 0x0006,	0.117,		L"MH_SPD_FB  ",	NULL },//006 MKLOG_ITEM_MH_SPD_FB   
		{ 0x0007,	0.208,		L"BH_SPD_FB  ",	NULL },//007 MKLOG_ITEM_BH_SPD_FB   
		{ 0x0008,	0.035,		L"SL_SPD_FB  ",	NULL },//008 MKLOG_ITEM_SL_SPD_FB   
		{ 0x0009,	0.2,		L"AH_SPD_FB  ",	NULL },//009 MKLOG_ITEM_AH_SPD_FB   
		{ 0x000A,	0.5,		L"GT_SPD_FB  ",	NULL },//010 MKLOG_ITEM_GT_SPD_FB   
		{ 0x000B,	0.117,		L"MH_SPD_REF ",	NULL },//011 MKLOG_ITEM_MH_SPD_REF  
		{ 0x000C,	0.208,		L"BH_SPD_REF ",	NULL },//012 MKLOG_ITEM_BH_SPD_REF  
		{ 0x000D,	0.035,		L"SL_SPD_REF ",	NULL },//013 MKLOG_ITEM_SL_SPD_REF  
		{ 0x000E,	0.2,		L"AH_SPD_REF ",	NULL },//014 MKLOG_ITEM_AH_SPD_REF  
		{ 0x000F,	0.5,		L"GT_SPD_REF ",	NULL },//015 MKLOG_ITEM_GT_SPD_REF 
		...
		{ 0xC0C2,	800.0,		L"GRIP SW  ",	NULL },//194 MKLOG_ITEM_GRIP_SWITCH

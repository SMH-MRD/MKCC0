...
//		  CODE		100%		Title			*func
		...
		{ 0x0015,	0.0,		L"-",			NULL },//021 MKLOG_ITEM_SWY1_TIL_Y	5deg/100%
		{ 0x0016,	0.0,		L"-",			NULL },//022 MKLOG_ITEM_SWY1_DTIL_X	5deg * 2ÉŒ/10ïbÅ@/100%
		{ 0x0017,	0.0,		L"-",			NULL },//023 MKLOG_ITEM_SWY1_DTIL_Y	ÉŒ/100/s/100%
		{ 0x0018,	30.0,		L"SW1Tx      ",	NULL },//024  MKLOG_ITEM_SWY1_TX		
		{ 0x0019,	30.0,		L"SW1Ty      ",	NULL },//025  MKLOG_ITEM_SWY1_TY		
		{ 0x001a,	1024,		L"SW1V/WX    ",	NULL },//026  MKLOG_ITEM_SWY1_DTHWX		
		{ 0x001b,	768,		L"SW1V/WY    ",	NULL },//027  MKLOG_ITEM_SWY1_DTHWY		
		{ 0x001c,	1024,		L"SW1AMP_CALX", NULL },//028  MKLOG_ITEM_SWY1_AMP_CAL_X	
		{ 0x001d,	768,		L"SW1AMP_CALY",	NULL },//029  MKLOG_ITEM_SWY1_AMP_CAL_Y	
		{ 0x001e,	PI180,		L"SW1PH_CALX" ,	NULL },//030  MKLOG_ITEM_SWY1_PH_CAL_X	
		{ 0x001f,	PI180,		L"SW1PH_CALY" ,	NULL },//031  MKLOG_ITEM_SWY1_PH_CAL_Y	
		{ 0x0020,	1024,		L"SW1AMP_P2PX",	NULL },//032  MKLOG_ITEM_SWY1_AMP_P2P_X	
		{ 0x0021,	768,		L"SW1AMP_P2PY",	NULL },//033  MKLOG_ITEM_SWY1_AMP_P2P_Y	
		{ 0x0022,	PI180,		L"SW1PH_TIMEX",	NULL },//034  MKLOG_ITEM_SWY1_PH_TIME_X	
		{ 0x0023,	PI180,		L"SW1PH_TIMEY",	NULL },//035  MKLOG_ITEM_SWY1_PH_TIME_Y	
		{ 0x0024,	100.0,		L"MH L"		  ,	NULL },//036Å@MKLOG_ITEM_MHL
		{ 0,		0.0,		L"-",			NULL },//037
		{ 0,		0.0,		L"-",			NULL },//038
		{ 0,		0.0,		L"-",			NULL },//039
		{ 0,		0.0,		L"-",			NULL },//040

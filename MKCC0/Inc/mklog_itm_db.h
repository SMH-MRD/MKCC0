...
typedef struct tagMklogItemUnit {
	...
	double d100;
	WCHAR title[16];
	INT16(*func)(double d);//ì¸óÕílÇ100%ílÇ…ê≥ãKâªÇ∑ÇÈä÷êî
...
#define MKLOG_ITEM_SWY1_TH_X		16	//êUÇÍäpÅ@X
#define MKLOG_ITEM_SWY1_TH_Y		17	//êUÇÍäpÅ@Y
#define MKLOG_ITEM_SWY1_DTH_X		18	//êUÇÍäpë¨ìxÅ@X
#define MKLOG_ITEM_SWY1_DTH_Y		19	//êUÇÍäpë¨ìxÅ@Y
...
#define MKLOG_ITEM_NOTCH_FB_MH		55
#define MKLOG_ITEM_NOTCH_FB_GT		56
#define MKLOG_ITEM_NOTCH_FB_BH		57
#define MKLOG_ITEM_NOTCH_FB_SL		58
#define MKLOG_ITEM_NOTCH_FB_AH		59

//MENTENANCE
#define MKLOG_ITEM_SIN_1HZ		    124	//CHECKópSINEÉJÅ[Éu
#define MKLOG_ITEM_COS_1HZ			125	//CHECKópCOSÉJÅ[Éu
#define MKLOG_ITEM_SIN_1HZ01HZ	    126	//CHECKópSINEÉJÅ[ÉuêUïùïœí≤Ç†ÇË
#define MKLOG_ITEM_COS_1HZ01HZ		127//CHECKópCOSÉJÅ[ÉuêUïùïœí≤Ç†ÇË
//16bit DIO
...
#define MKLOG_ITEM_SL_BRK_PSW		195//ê˘âÒÉuÉåÅ[ÉLà≥óÕSW
...
typedef struct ST_MKLOG_DB {
	...
	{
//		  CODE		100%		Title			*func
		{ 0x0000,	0.0,		L"NA",			NULL },//000 MKLOG_ITEM_TIME		ÉçÉOéÌï ÉRÅ[Éh  
		{ 0x0001,	0.0,		L"COUNT",		NULL },//001 MKLOG_ITEM_COUNT   Å@Å@çÄñ⁄êî  
		{ 0x0002,	80.0,		L"MH_POS_FB  ",	NULL },//002 MKLOG_ITEM_MH_POS_FB   
		{ 0x0003,	60.0 ,		L"BH_POS_FB  ",	NULL },//003 MKLOG_ITEM_BH_POS_FB   ê˘âÒîºåa
		{ 0x0004,	360.0 ,		L"SL_POS_FB  ",	NULL },//004 MKLOG_ITEM_SL_POS_FB   
		{ 0x0005,	80.0 ,		L"AH_POS_FB  ",	NULL },//005 MKLOG_ITEM_AH_POS_FB   
		{ 0x0006,	2250.0,		L"MH_SPD_FB  ",	NULL },//006 MKLOG_ITEM_MH_SPD_FB   100%->1000
		{ 0x0007,	1750.0,		L"BH_SPD_FB  ",	NULL },//007 MKLOG_ITEM_BH_SPD_FB   100%->1000
		{ 0x0008,	1750.0,		L"SL_SPD_FB  ",	NULL },//008 MKLOG_ITEM_SL_SPD_FB   100%->1000
		{ 0x0009,	2000.0,		L"AH_SPD_FB  ",	NULL },//009 MKLOG_ITEM_AH_SPD_FB   100%->1000
		{ 0x000A,	1700.0,		L"GT_SPD_FB  ",	NULL },//010 MKLOG_ITEM_GT_SPD_FB   100%->1000
		{ 0x000B,	3000.0,		L"MH_SPD_REF ",	NULL },//011 MKLOG_ITEM_MH_SPD_REF  100%->1000
		{ 0x000C,	1000.0,		L"BH_SPD_REF ",	NULL },//012 MKLOG_ITEM_BH_SPD_REF  100%->1000 
		...
		{ 0x0010,	512.0,		L"SW1_PX    " , NULL },//016 MKLOG_ITEM_SWY1_TH_XÅ@	êUÇÍäpPIX
		{ 0x0011,	384.0,		L"SW1_PY    " , NULL },//017 MKLOG_ITEM_SWY1_TH_YÅ@	êUÇÍäpPIX	
		{ 0x0012,	512.0,		L"SW1_VX   "  , NULL },//018 MKLOG_ITEM_SWY1_DTH_X	êUÇÍäpë¨ìx PIX/sÅ@1ïbÇ≈îºï™ÇÃâÊäp
		{ 0x0013,	384.0,		L"SW1_VY   "  , NULL },//019 MKLOG_ITEM_SWY1_DTH_Y	êUÇÍäpë¨ìx PIX/s  1ïbÇ≈îºï™ÇÃâÊäp
		{ 0x0014,	0.0,		L"-",			NULL },//020 MKLOG_ITEM_SWY1_TIL_X	åXéŒåväpìx
		{ 0x0015,	0.0,		L"-",			NULL },//021 MKLOG_ITEM_SWY1_TIL_Y	åXéŒåväpìx
		{ 0x0016,	0.0,		L"-",			NULL },//022 MKLOG_ITEM_SWY1_DTIL_X	åXéŒåväpë¨ìx
		{ 0x0017,	0.0,		L"-",			NULL },//023 MKLOG_ITEM_SWY1_DTIL_Y	åXéŒåväpë¨ìx
		{ 0x0018,	30.0,		L"SW1Tx      ",	NULL },//024  MKLOG_ITEM_SWY1_TX	êUÇÍé¸ä˙	
		{ 0x0019,	30.0,		L"SW1Ty      ",	NULL },//025  MKLOG_ITEM_SWY1_TY	êUÇÍé¸ä˙	
		{ 0x001a,	512,		L"SW1V/WX    ",	NULL },//026  MKLOG_ITEM_SWY1_DTHWX	dÉ∆/dt/É÷	
		{ 0x001b,	384,		L"SW1V/WY    ",	NULL },//027  MKLOG_ITEM_SWY1_DTHWY	dÉ∆/dt/É÷	
		{ 0x001c,	1024,		L"SW1AMP_CALX", NULL },//028  MKLOG_ITEM_SWY1_AMP_CAL_X		êUÇÍêUïùíÄéüåvéZéÆ
		{ 0x001d,	768,		L"SW1AMP_CALY",	NULL },//029  MKLOG_ITEM_SWY1_AMP_CAL_Y		êUÇÍêUïùíÄéüåvéZéÆ
		{ 0x001e,	PI180,		L"SW1PH_CALX" ,	NULL },//030  MKLOG_ITEM_SWY1_PH_CAL_X		êUÇÍà ëäíÄéüåvéZéÆ
		{ 0x001f,	PI180,		L"SW1PH_CALY" ,	NULL },//031  MKLOG_ITEM_SWY1_PH_CAL_Y		êUÇÍà ëäíÄéüåvéZéÆ
		{ 0x0020,	1024,		L"SW1AMP_P2PX",	NULL },//032  MKLOG_ITEM_SWY1_AMP_P2P_X		êUÇÍêUïùÉsÅ[ÉNåvë™ï˚	
		{ 0x0021,	768,		L"SW1AMP_P2PY",	NULL },//033  MKLOG_ITEM_SWY1_AMP_P2P_Y		êUÇÍêUïùÉsÅ[ÉNåvë™ï˚
		{ 0x0022,	PI180,		L"SW1PH_TIMEX",	NULL },//034  MKLOG_ITEM_SWY1_PH_TIME_X		êUÇÍà ëäéûä‘ÉJÉEÉìÉg
		{ 0x0023,	PI180,		L"SW1PH_TIMEY",	NULL },//035  MKLOG_ITEM_SWY1_PH_TIME_Y		êUÇÍà ëäéûä‘ÉJÉEÉìÉg
		{ 0x0024,	100.0,		L"MH L"		  ,	NULL },//036Å@MKLOG_ITEM_MHL				í›ì_çÇÇ≥-ógíˆ			
		{ 0,		0.0,		L"-",			NULL },//037
		{ 0,		0.0,		L"-",			NULL },//038
		{ 0,		0.0,		L"-",			NULL },//039
		{ 0,		0.0,		L"-",			NULL },//040
		...
		{ 0x0035,	4.0,		L"SL_NOTCH_REF",NULL },//053 MKLOG_ITEM_NOTCH_COM_SL
		{ 0x0036,	4.0,		L"AH_NOTCH_REF",NULL },//054 MKLOG_ITEM_NOTCH_COM_AH
		{ 0x0037,	4.0,		L"MH_NOTCH_FB",	NULL },//055 MKLOG_ITEM_NOTCH_FB_MH
		{ 0x0038,	4.0,		L"GT_NOTCH_FB",	NULL },//056 MKLOG_ITEM_NOTCH_FB_GT
		{ 0x0039,	4.0,		L"BH_NOTCH_FB",	NULL },//057 MKLOG_ITEM_NOTCH_FB_BH
		{ 0x003a,	4.0,		L"SL_NOTCH_FB",	NULL },//058 MKLOG_ITEM_NOTCH_FB_SL
		{ 0x003b,	4.0,		L"AH_NOTCH_FB",	NULL },//059 MKLOG_ITEM_NOTCH_FB_AH
		{ 0,		0.0,		L"-",			NULL },//060
		{ 0,		0.0,		L"-",			NULL },//061
		{ 0,		0.0,		L"-",			NULL },//062
		{ 0,		0.0,		L"-",			NULL },//063
		...
		//BIT 100%ílÅÀ1000.0Ç≈ÉOÉâÉtÇÃ10%Ç≈ï\é¶(10000Ç™100%ï\é¶Ç»ÇÃÇ≈Åj
		...
		{ 0xC0C3,	800.0,		L"SLBRK_SW",	NULL },//195 ê˘âÒÉuÉåÅ[ÉLà≥óÕSW

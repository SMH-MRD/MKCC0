...
#define MKLOG_ITEM_SL_BRK_PSW		195Å@//ê˘âÒÉuÉåÅ[ÉLà≥óÕSW
...
//		  CODE		100%		Title			*func
		...
		{ 0x001a,	2048,		L"SW1V/WX    ",	NULL },//026  MKLOG_ITEM_SWY1_DTHWX		
		{ 0x001b,	1536,		L"SW1V/WY    ",	NULL },//027  MKLOG_ITEM_SWY1_DTHWY		
		...
		{ 0xC0C3,	0.0,		L"-",			NULL },//195 ê˘âÒÉuÉåÅ[ÉLà≥óÕSW

...
struct ST_MKLOG_SOURCE {
	...
	ST_LOG_HEADER header_time = {
		//code
		{
			...
			MKLOG_ITEM_SWY1_TH_X,MKLOG_ITEM_SWY1_TX,MKLOG_ITEM_SWY1_AMP_P2P_X,MKLOG_ITEM_SWY1_PH_TIME_X,MKLOG_ITEM_SWY1_DTHWX,MKLOG_ITEM_EMPTY,MKLOG_ITEM_EMPTY,MKLOG_ITEM_EMPTY,

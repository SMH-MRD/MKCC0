...
struct ST_MKLOG_SOURCE {
	...
	ST_LOG_HEADER header_time = {
		...
		{
			1,16,
			MKLOG_ITEM_SL_SPD_REF,MKLOG_ITEM_SL_SPD_FB,MKLOG_ITEM_NOTCH_COM_SL,MKLOG_ITEM_MH_POS_FB,MKLOG_ITEM_BH_POS_FB,MKLOG_ITEM_MHL,MKLOG_ITEM_EMPTY,MKLOG_ITEM_EMPTY,
			MKLOG_ITEM_SWY1_TH_X,MKLOG_ITEM_SWY1_TX,MKLOG_ITEM_SWY1_AMP_CAL_X,MKLOG_ITEM_SWY1_AMP_P2P_X,MKLOG_ITEM_SWY1_PH_CAL_X,MKLOG_ITEM_SWY1_PH_TIME_X,MKLOG_ITEM_EMPTY,MKLOG_ITEM_EMPTY,

...
#include "framework.h"
#include "CCraneLib.h"
#include "each_crane.h"

ST_SPEC CCraneBase::_spec;

ST_SPEC CCraneBase::get_spec(){
	return _spec;
}

void CCraneBase::set_spec_H6R602() {
	_spec = {
		//ノッチ速度物理量
...
void CCraneBase::set_spec_HHGH29() {
	_spec = {
		//ノッチ速度物理量
		//double notch_spd_f[MOTION_ID_MAX][NOTCH_MAX] = {	//# ノッチ指令速度（機上）1倍速時
		{
...
void CCraneBase::set_spec_HHGQ18() {
	return;
}
void CCraneBase::set_spec_HHFR22() {
	return;
}

void CCraneBase::setup_plc_io_H6R602() {
	return;
}
void CCraneBase::setup_plc_io_HHGH29() {
	return;
}
void CCraneBase::setup_plc_io_HHGQ18() {
	return;
}
void CCraneBase::setup_plc_io_HHFR22() {
	return;
}

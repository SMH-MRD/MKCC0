...
HRESULT CCraneBase::setup_crane(int crane_id) {
	...
	case CARNE_ID_HHGH29: {//今造西多度津70tJC　102号
		...
		pw16 = pw016 + 3;	pr16 = pr016 + 3;
		{
			...
			objs.sw_mlim_pre_warning = new CBitIO(pr16, pw16, &prmw16, &prmr16);
		}

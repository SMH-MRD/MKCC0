	...
	//CARNE_ID_HHGH29
	{
		...
		ST_ADDR_SET st_src =
		{
			{//PC
				...
				{"192.168.100.102",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,10003,0},	//ID_COMM_LANIO
				default_addr,
				default_addr,
				default_addr
			},	
			...
			{//AUX
				...
				{"192.168.0.31",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,10003,0},	//ID_COMM_LANIO
				default_addr,
				default_addr,
				default_addr,
			},	

	...
	//CARNE_ID_HHGQ18
	{
		...
		ST_ADDR_SET st_src =
		{
			{//PC
				...
				{"192.168.110.101",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,8001,0},	//ID_COMM_CRANE_OTE_IF
				{"192.168.110.100",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,3021,0},	//ID_COMM_PC_SLBRK
				{"192.168.100.103",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,10080,0},	//ID_COMM_SENSOR
				default_addr,
				default_addr,
				default_addr,
				default_addr
			...
			{//AUX
				...
				default_addr,
				{"192.168.101.120",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,3011,0},	//ID_COMM_PC_SLBRK
				{"192.168.100.121",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,10081,0},	//ID_COMM_SENSOR
			},
		};
		set_addr_set(CODE_COMM_LOCATION_CRANE, machine_id, &st_src);
	}
	...
	//CARNE_ID_H6R602
	{
		...
		ST_ADDR_SET st_src =
		{
			{//PC
				...
				{"192.168.110.101",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,8001,0},	//ID_COMM_CRANE_OTE_IF
				{"192.168.110.100",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,3021,0},	//ID_COMM_PC_SLBRK
				{"192.168.101.103",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,10080,0},	//ID_COMM_SWAY_SENSOR
				default_addr,
				default_addr,
				default_addr,
				default_addr

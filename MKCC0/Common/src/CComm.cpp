	...
	//CARNE_ID_HHGH29
	{
		...
		ST_ADDR_SET st_src =
		{
			{//PC
				...
				{"172.31.0.0",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,10080,0},		//ID_COMM_SENSOR
			...
			{//AUX
				...
				{"172.31.0.32",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,10081,0},	//ID_COMM_SENSOR
	...
	//CARNE_ID_H6R602
	{
		...
		ST_ADDR_SET st_src =
		{
			{//PC
				...
				{"192.168.100.103",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_UDP,8001,0},	//ID_COMM_CRANE_OTE_IF
			...
			{//PLC
				{"192.168.100.101",CODE_COMM_TYPE_LAN,CODE_COMM_PROTOCOL_MC,3010,0},	//ID_COMM_MAIN_PC_PLC
				default_addr
			},
			{//AUX
				default_addr,

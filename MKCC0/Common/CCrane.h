...
public:
	...
	//PLC通信バッファ
	LPST_HHGH29_PLC_R get_plc_rif()	{ if (pPlc != NULL) return &(pPlc->un_plc_io_rif.hhgh29);	return NULL;}
	LPST_HHGH29_PLC_W get_plc_wif()	{ if (pPlc != NULL) return &(pPlc->un_plc_io_wif.hhgh29);	return NULL;}

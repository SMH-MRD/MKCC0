...
ST_STRUCTURE	st_struct_hhgh29 = {
	...
	52.809,		//起伏上限時d
	10000.0,		//フック重量KG	
	334.97,      //巻ドラム（主巻,引込）の合計値
	667.00	    //主巻ロープ長
};

//軸仕様
ST_AXIS_SPEC	axis_spec_hhgh29[MOTION_ID_MAX] = {
	{//主巻
	...
	{//走行
		...
		88.0,			// Kw_rated;	定格出力（kW：100％)
		87.5,			// Gear_ratio;	減速比(モータ回転 /ドラム回転 ）
		0.5,			// Ddrm0;		ドラム径0
		0.0,			// Ddrm1;		ドラム径1
		1.0,			// Nwire0;		ロープ掛数
		1.0,			// Nwire1;		ロープ掛数
...
//自動仕様
ST_AUTO_SPEC    auto_spec_hhgh29[MOTION_ID_MAX] =
{
	{//主巻

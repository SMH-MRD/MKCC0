static ST_OBJ_PROPERTY main_props_hhgh29[N_MAIN_PNL_OBJ] = {
...
static ST_OBJ_PROPERTY sub_set_props_hhgh29[N_SUB_PNL_OBJ] = {
	//設定サブウィンドウ
...
static ST_OBJ_PROPERTY gwin_set_props_hhgh29[N_GWIN_OBJ] = {
	//グラフィックMAINウィンドウ
...
static ST_OBJ_PROPERTY gsubwin_set_props_hhgh29[N_GSUBWIN_OBJ] = {
	//グラフィックMAINウィンドウ

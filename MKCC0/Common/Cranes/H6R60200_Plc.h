...
ST_JC_PLC_IO_R plc_io_rdef_h6r602 = {
	...
	{NULL,0xFC000,				CODE_PLCIO_BITS,	10,0,6},//ah_notch;
	...
	//X0C0
	{NULL,BIT3,					CODE_PLCIO_BIT,		0,0,66},	//brk_mc3_fb;		//ブレーキ主幹アンサーバック
	{NULL,BIT4,					CODE_PLCIO_BIT,		0,0,66},	//mh_brk1_fb;		//主巻ブレーキアンサーバック
	{NULL,BIT5,					CODE_PLCIO_BIT,		0,0,66},	//bh_brk_fb;		//引込ブレーキアンサーバック
	{NULL,BIT6,					CODE_PLCIO_BIT,		0,0,66},	//gt_brk_fb;		//走行ブレーキアンサーバック
	{NULL,BIT7,					CODE_PLCIO_BIT,		0,0,66},	//ah_brk_fb;		//ホイップブレーキアンサーバック

	//インバータへの指令出力内容

	{NULL,BIT0,					CODE_PLCIO_BIT,		0,0,116},//inv_fwd_mh
	{NULL,BIT1,					CODE_PLCIO_BIT,		0,0,116},//inv_rev_mh
	{NULL,BIT0,					CODE_PLCIO_BIT,		0,0,115},//inv_fwd_bh
	{NULL,BIT1,					CODE_PLCIO_BIT,		0,0,115},//inv_rev_bh
	{NULL,BIT0,					CODE_PLCIO_BIT,		0,0,114},//inv_fwd_sl
	{NULL,BIT1,					CODE_PLCIO_BIT,		0,0,114},//inv_rev_sl
	{NULL,BIT0,					CODE_PLCIO_BIT,		0,0,112},//inv_fwd_gt
	{NULL,BIT1,					CODE_PLCIO_BIT,		0,0,112},//inv_rev_gt
	{NULL,BIT0,					CODE_PLCIO_BIT,		0,0,113},//inv_fwd_ah
	...
	{NULL,BITFF,				CODE_PLCIO_DWORD,	0,0,88},	//hcounter_ah
	{NULL,BITFF,				CODE_PLCIO_DWORD,	0,0,90},	//hcounter_bh
	{NULL,BITFF,				CODE_PLCIO_DWORD,	0,0,92},	//hcounter_sl

	{NULL,BITFF,				CODE_PLCIO_DWORD,	0,0,94},	//absocoder_mh
	{NULL,BITFF,				CODE_PLCIO_DWORD,	0,0,96},	//absocoder_ah
	{NULL,BITFF,				CODE_PLCIO_DWORD,	0,0,98},	//absocoder_gt
	//荷重
	{NULL,BITFF,				CODE_PLCIO_WORD,	0,0,4},		//m 荷重
...
ST_JC_PLC_IO_W plc_io_wdef_h6r602 = {
	...
	//B250
	{NULL,0x003F,				CODE_PLCIO_BITS,	0,0,9},	//bh_notch;
	{NULL,BIT6 | BIT6,			CODE_PLCIO_BITS,	0,0,9},	//ah_spd_cs;
	{NULL,BIT8,					CODE_PLCIO_BIT,		0,0,9},	//sl_brake;
	{NULL,0x7E00,				CODE_PLCIO_BITS,	9,0,9},	//sl_notch;
	...
	{NULL,BITFF,				CODE_PLCIO_WORD,	0,0,74},//vfb_ah;

	{NULL,BITFF,				CODE_PLCIO_WORD,	0,0,75},//trqref_mh
	{NULL,BITFF,				CODE_PLCIO_WORD,	0,0,76},//trqref_bh
	{NULL,BITFF,				CODE_PLCIO_WORD,	0,0,77},//trqref_ah

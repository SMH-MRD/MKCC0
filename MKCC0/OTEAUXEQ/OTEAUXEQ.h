...
#define AUX_AGENT_SCAN_MS			20
#define AUX_POLICY_SCAN_MS			40
#define AUX_SCADA_SCAN_MS			100
#define AUX_SIM_SCAN_MS			    100

#define NAME_OF_INIFILE					L"oteaux"		//iniファイルファイル名
...
#define PRM_N_TASK_MSGLIST_ROW      100 
    ...
    typedef struct _ST_OTEAUXEQ_WND {
        HWND hWnd_status_bar;
        HWND hWnd;

        INT32 USB_cam_thread_status = L_OFF;

    } ST_OTEAUXEQ_WND, * LPST__OTEAUXEQ_WND;
}
